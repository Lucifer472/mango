export const CashDeliveryAnimation = () => {
  return (
    <div className="flex items-center justify-center w-full">
      <span className="w-fit text-center font-medium block mt-6 text-xl relative">
        Cash on Delivery
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 500 150"
          preserveAspectRatio="none"
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 overflow-visible svgWidthAndHeight flex"
        >
          <path
            style={{
              strokeWidth: "6px",
